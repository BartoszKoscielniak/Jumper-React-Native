...
const lvl3 = () => {
    ...
    return {
        ...
        Platform1: Obstacle3 ( world, 'red', platformSizePosAA.platform.pos, platformSizePosAA.platform.size ),
        Platform2: Obstacle3 ( world, 'red', platformSizePosA.platform.pos, platformSizePosA.platform.size ),
        Platform3: Obstacle3 ( world, 'purple', platformSizePosB.platform.pos, platformSizePosB.platform.size ),
        Platform4: Obstacle3 ( world, 'grey', platformSizePosC.platform.pos, platformSizePosC.platform.size ),
        Platform5: Obstacle3 ( world, 'black', platformSizePosD.platform.pos, platformSizePosD.platform.size ),
        Platform6: Obstacle3 ( world, 'black', {x: platformSizePosB.platform.pos.x + 30 + platformSizePosB.platform.size.width, y: platformSizePosB.platform.pos.y}, {width: platformSizePosB.platform.size.width / 2, height: platformSizePosB.platform.size.height} ),
