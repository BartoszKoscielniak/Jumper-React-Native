...
const lvl2 = () => {
    ...
    return {
        ...
        Platform1: Obstacle2 ( world, 'red', platformSizePosAA.platform.pos, platformSizePosAA.platform.size ),
        Platform2: Obstacle2 ( world, 'red', platformSizePosA.platform.pos, platformSizePosA.platform.size ),
        Platform3: Obstacle2 ( world, 'purple', platformSizePosB.platform.pos, platformSizePosB.platform.size ),
        Platform4: Obstacle2 ( world, 'grey', platformSizePosC.platform.pos, platformSizePosC.platform.size ),
        Platform5: Obstacle2 ( world, 'black', platformSizePosD.platform.pos, platformSizePosD.platform.size ),
        Platform6: Obstacle2 ( world, 'black', {x: platformSizePosB.platform.pos.x + 30 + platformSizePosB.platform.size.width, y: platformSizePosB.platform.pos.y}, {width: platformSizePosB.platform.size.width / 2, height: platformSizePosB.platform.size.height} ),

        Bomb1: Bomb(world, 'Bomb', 'black', {x:155, y: -100}, {width: 28, height: 28}),
        Bomb2: Bomb(world, 'Bomb', 'black', {x:333, y: -100}, {width: 28, height: 28}),

        PlayerVelocity:     {x: 8, y: 35},
